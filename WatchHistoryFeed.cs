...
namespace Lincon
{
    public static class WatchHistoryFeed
    {
        public static void HandleFeed(WebApplication app)
        {
            ...
            async Task<string> UseInnerTube(string? accessToken)
            {
                ...
                var payload = new
                {
                    ...
                    // this is the end point for the history page of youtube
            ...
            Tuple<string, int> ExtractData(string json, string access_token, HttpRequest request)
            {
                ...
                // the FEhistory feed is layed out like this
            ...
            app.MapGet("/feeds/api/users/default/watch_history", async (HttpRequest request) =>
            {
                try
                {
